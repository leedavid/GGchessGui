...
#define ICS_HOST            _T("chessclub.com")
#define ICS_PORT	        _T("5000")
#define ICS_COMM_PORT       _T("")
#define FIRST_HOST			_T("localhost")
#define SECOND_HOST			_T("localhost")
#define TELNET_PROGRAM		_T("telnet")
#define MATCH_MODE			_T("False")
#define INIT_STRING			_T("new\nrandom\n")
#define WHITE_STRING		_T("white\ngo\n")
#define BLACK_STRING		_T("black\ngo\n")
#define COMPUTER_STRING         _T("computer\n")
#define REUSE_CHESS_PROGRAMS    1
#define WHITE_PIECE_COLOR	_T("#FFFFCC")
#define BLACK_PIECE_COLOR	_T("#202020")
#define LIGHT_SQUARE_COLOR	_T("#C8C365")
#define DARK_SQUARE_COLOR	_T("#77A26D")
#define JAIL_SQUARE_COLOR       _T("#808080")
#define HIGHLIGHT_SQUARE_COLOR	_T("#FFFF00")
#define PREMOVE_HIGHLIGHT_COLOR	_T("#FF0000")
#define BELLCHAR                '\007'
#define NULLCHAR                '\000'
...
/* Static */
#define POSITION_FILT _T("Position files (*.fen,*.epd,*.pos)\0*.fen;*.epd;*.pos\0All files (*.*)\0*.*\0")
#define GAME_FILT     _T("Game files (*.pgn,*.gam)\0*.pgn;*.gam\0All files (*.*)\0*.*\0")
#define SOUND_FILT    _T("Wave files (*.wav)\0*.wav\0All files (*.*)\0*.*\0")
//#define OUTER_MARGIN (pDis->tinyLayout ? 0 : 4)
//#define INNER_MARGIN (pDis->tinyLayout ? 0 : 2)

#define OUTER_MARGIN (pDis->tinyLayout ? 4:  4)
#define INNER_MARGIN (pDis->tinyLayout ? 2 : 2)

#define MESSAGE_LINE_LEFTMARGIN 2
#define MESSAGE_TEXT_MAX 256
/*#define COLOR_ECHOOFF RGB(192,192,192)*/
#define COLOR_ECHOOFF TAB.consoleBackgroundColor
#define WRAP_INDENT 200


#define CLOCK_FONT_TINY        _T("Arial:6.0 b")
#define CLOCK_FONT_TEENY       _T("Arial:6.0 b")
#define CLOCK_FONT_DINKY       _T("Arial:6.0 b")
#define CLOCK_FONT_PETITE      _T("Arial:6.0 b")
#define CLOCK_FONT_SLIM        _T("Arial:6.0 b")
#define CLOCK_FONT_SMALL       _T("Arial:6.0 b")
#define CLOCK_FONT_MEDIOCRE    _T("Arial:6.0 b")
#define CLOCK_FONT_MIDDLING    _T("Arial:6.0 b")
#define CLOCK_FONT_AVERAGE     _T("Arial:6.0 b")
#define CLOCK_FONT_MODERATE    _T("Arial:6.0 b")
#define CLOCK_FONT_MEDIUM      _T("Arial:6.0 b")
#define CLOCK_FONT_BULKY       _T("Arial:6.0 b")
#define CLOCK_FONT_LARGE       _T("Arial:6.0 b")
#define CLOCK_FONT_BIG         _T("Arial:6.0 b")
#define CLOCK_FONT_HUGE        _T("Arial:6.0 b")
#define CLOCK_FONT_GIANT       _T("Arial:6.0 b")
#define CLOCK_FONT_COLOSSAL    _T("Arial:6.0 b")
#define CLOCK_FONT_TITANIC     _T("Arial:6.0 b")


#define MESSAGE_FONT_TINY      _T("Small Fonts:6.0")
#define MESSAGE_FONT_TEENY     _T("Small Fonts:6.0")
#define MESSAGE_FONT_DINKY     _T("Small Fonts:6.0")
#define MESSAGE_FONT_PETITE    _T("Small Fonts:6.0")
#define MESSAGE_FONT_SLIM      _T("Arial:5.0 b")
#define MESSAGE_FONT_SMALL     _T("Arial:5.0 b")
#define MESSAGE_FONT_MEDIOCRE  _T("Arial:5.0 b")
#define MESSAGE_FONT_MIDDLING  _T("Arial:5.0 b")
#define MESSAGE_FONT_AVERAGE   _T("Arial:5.0 b")
#define MESSAGE_FONT_MODERATE  _T("Arial:5.0 b")
#define MESSAGE_FONT_MEDIUM    _T("Arial:5.0 b")
#define MESSAGE_FONT_BULKY     _T("Arial:5.0 b")
#define MESSAGE_FONT_LARGE     _T("Arial:5.0 b")
#define MESSAGE_FONT_BIG       _T("Arial:5.0 b")
#define MESSAGE_FONT_HUGE      _T("Arial:5.0 b")
#define MESSAGE_FONT_GIANT     _T("Arial:5.0 b")
#define MESSAGE_FONT_COLOSSAL  _T("Arial:5.0 b")
#define MESSAGE_FONT_TITANIC   _T("Arial:5.0 b")

//#define MESSAGE_FONT_TINY      _T("Small Fonts:6.0")
//#define MESSAGE_FONT_TEENY     _T("Small Fonts:6.0")
//#define MESSAGE_FONT_DINKY     _T("Small Fonts:7.0")
//#define MESSAGE_FONT_PETITE    _T("Small Fonts:7.0")
//#define MESSAGE_FONT_SLIM      _T("Arial:8.0 b")
//#define MESSAGE_FONT_SMALL     _T("Arial:9.0 b")
//#define MESSAGE_FONT_MEDIOCRE  _T("Arial:9.0 b")
//#define MESSAGE_FONT_MIDDLING  _T("Arial:9.0 b")
//#define MESSAGE_FONT_AVERAGE   _T("Arial:10.0 b")
//#define MESSAGE_FONT_MODERATE  _T("Arial:10.0 b")
//#define MESSAGE_FONT_MEDIUM    _T("Arial:10.0 b")
//#define MESSAGE_FONT_BULKY     _T("Arial:10.0 b")
//#define MESSAGE_FONT_LARGE     _T("Arial:10.0 b")
//#define MESSAGE_FONT_BIG       _T("Arial:11.0 b")
//#define MESSAGE_FONT_HUGE      _T("Arial:11.0 b")
//#define MESSAGE_FONT_GIANT     _T("Arial:11.0 b")
//#define MESSAGE_FONT_COLOSSAL  _T("Arial:12.0 b")
//#define MESSAGE_FONT_TITANIC   _T("Arial:12.0 b")

#define COORD_FONT_TINY        _T("Small Fonts:4.0")
#define COORD_FONT_TEENY       _T("Small Fonts:4.0")
#define COORD_FONT_DINKY       _T("Small Fonts:5.0")
#define COORD_FONT_PETITE      _T("Small Fonts:5.0")
#define COORD_FONT_SLIM        _T("Small Fonts:6.0")
#define COORD_FONT_SMALL       _T("Small Fonts:7.0")
#define COORD_FONT_MEDIOCRE    _T("Small Fonts:7.0")
#define COORD_FONT_MIDDLING    _T("Small Fonts:7.0")
#define COORD_FONT_AVERAGE     _T("Arial:6.0 b")
#define COORD_FONT_MODERATE    _T("Arial:6.0 b")
#define COORD_FONT_MEDIUM      _T("Arial:6.0 b")
#define COORD_FONT_BULKY       _T("Arial:6.0 b")
#define COORD_FONT_LARGE       _T("Arial:6.0 b")
#define COORD_FONT_BIG         _T("Arial:6.0 b")
#define COORD_FONT_HUGE        _T("Arial:6.0 b")
#define COORD_FONT_GIANT       _T("Arial:6.0 b")
#define COORD_FONT_COLOSSAL    _T("Arial:6.0 b")
#define COORD_FONT_TITANIC     _T("Arial:6.0 b")

#define CONSOLE_FONT_TINY      _T("Fixedsys:6.0")
#define CONSOLE_FONT_TEENY     _T("Fixedsys:6.0")
#define CONSOLE_FONT_DINKY     _T("Fixedsys:6.0")
#define CONSOLE_FONT_PETITE    _T("Fixedsys:6.0")
#define CONSOLE_FONT_SLIM      _T("Fixedsys:6.0")
#define CONSOLE_FONT_SMALL     _T("Fixedsys:6.0")
#define CONSOLE_FONT_MEDIOCRE  _T("Fixedsys:6.0")
#define CONSOLE_FONT_MIDDLING  _T("Fixedsys:6.0")
#define CONSOLE_FONT_AVERAGE   _T("Fixedsys:6.0")
#define CONSOLE_FONT_MODERATE  _T("Fixedsys:6.0")
#define CONSOLE_FONT_MEDIUM    _T("Fixedsys:6.0")
#define CONSOLE_FONT_BULKY     _T("Fixedsys:6.0")
#define CONSOLE_FONT_LARGE     _T("Fixedsys:6.0")
#define CONSOLE_FONT_BIG       _T("Fixedsys:6.0")
#define CONSOLE_FONT_HUGE      _T("Fixedsys:6.0")
#define CONSOLE_FONT_GIANT     _T("Fixedsys:6.0")
#define CONSOLE_FONT_COLOSSAL  _T("Fixedsys:6.0")
#define CONSOLE_FONT_TITANIC   _T("Fixedsys:6.0")


#define COMMENT_FONT_TINY     _T("Arial:6.0")
#define COMMENT_FONT_TEENY    _T("Arial:6.0")
#define COMMENT_FONT_DINKY    _T("Arial:6.0")
#define COMMENT_FONT_PETITE   _T("Arial:6.0")
#define COMMENT_FONT_SLIM     _T("Arial:6.0")
#define COMMENT_FONT_SMALL    _T("Arial:6.0")
#define COMMENT_FONT_MEDIOCRE _T("Arial:6.0")
#define COMMENT_FONT_MIDDLING _T("Arial:6.0")
#define COMMENT_FONT_AVERAGE  _T("Arial:6.0")
#define COMMENT_FONT_MODERATE _T("Arial:6.0")
#define COMMENT_FONT_MEDIUM   _T("Arial:6.0")
#define COMMENT_FONT_BULKY    _T("Arial:6.0")
#define COMMENT_FONT_LARGE    _T("Arial:6.0")
#define COMMENT_FONT_BIG      _T("Arial:6.0")
#define COMMENT_FONT_HUGE     _T("Arial:6.0")
#define COMMENT_FONT_GIANT    _T("Arial:6.0")
#define COMMENT_FONT_COLOSSAL _T("Arial:6.0")
#define COMMENT_FONT_TITANIC  _T("Arial:6.0")

#define EDITTAGS_FONT_TINY     _T("Courier New:6.0")
#define EDITTAGS_FONT_TEENY    _T("Courier New:6.0")
#define EDITTAGS_FONT_DINKY    _T("Courier New:6.0")
#define EDITTAGS_FONT_PETITE   _T("Courier New:6.0")
#define EDITTAGS_FONT_SLIM     _T("Courier New:6.0")
#define EDITTAGS_FONT_SMALL    _T("Courier New:6.0")
#define EDITTAGS_FONT_MEDIUM   _T("Courier New:6.0")
#define EDITTAGS_FONT_MEDIOCRE _T("Courier New:6.0")
#define EDITTAGS_FONT_MIDDLING _T("Courier New:6.0")
#define EDITTAGS_FONT_AVERAGE  _T("Courier New:6.0")
#define EDITTAGS_FONT_MODERATE _T("Courier New:6.0")
#define EDITTAGS_FONT_BULKY    _T("Courier New:6.0")
#define EDITTAGS_FONT_LARGE    _T("Courier New:6.0")
#define EDITTAGS_FONT_BIG      _T("Courier New:6.0")
#define EDITTAGS_FONT_HUGE     _T("Courier New:6.0")
#define EDITTAGS_FONT_GIANT    _T("Courier New:6.0")
#define EDITTAGS_FONT_COLOSSAL _T("Courier New:6.0")
#define EDITTAGS_FONT_TITANIC  _T("Courier New:6.0")

#define COLOR_SHOUT           _T("#209000")
#define COLOR_SSHOUT         _T("b #289808")
#define COLOR_CHANNEL1         _T("#2020E0")
#define COLOR_CHANNEL        _T("b #4040FF")
#define COLOR_KIBITZ         _T("b #FF00FF")
#define COLOR_TELL             _T("#FF0000")  //"b  #FF0000"
#define COLOR_CHALLENGE     _T("bi #FF0000")
#define COLOR_REQUEST       _T("bi #FF0000")
#define COLOR_SEEK             _T("#980808")
#define COLOR_NORMAL           _T("#000000")
#define COLOR_NONE             _T("#000000")
#define COLOR_BKGD             _T("#FFFFFF")
...
#define WM_USER_BOOK_MOVE             (WM_USER + 4302)   //有棋库走步了

//#define WM_USER_ICS_INFO			  (WM_USER + 4303)	 //联网信息输入
...
#define COPY_TMP  _T("wbcopy.tmp")
#define PASTE_TMP _T("wbpaste.tmp")
